(function($) {
    ...
    ArticlePages.prototype = {
        ...
        getPageLinks: function() {
            ...
            if (!this.$pageLinks) {
                var $list = $('<span class="pagination-inner"></span>');
            
                
                
                $list.append($('<a href="#" class="pagination-btn newer-btn">'+ this.options.newer +'</a>').click($.proxy(function(event) {
                ...
                $list.append($('<a href="#" class="pagination-btn older-btn">'+ this.options.older +'</a>').click($.proxy(function(event) {
                    event.preventDefault();
                    this.next();
                }, this)));
