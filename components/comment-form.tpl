  ...
  {% commentform %}
    ...
    <div class="form_area">
      <div class="form_fields">
        <div class="form_field form_field_small{% if comment_name_error %} form_field_with_errors{% endif %}">
          ...
          <input id="comment-form-name" class="form_field_textfield" name="comment[author]" value="{{ comment.author }}">
        </div>

        <div class="form_field form_field_small{% if comment_email_error %} form_field_with_errors{% endif %}">
          ...
          <input id="comment-form-email" class="form_field_textfield" name="comment[author_email]" value="{{ comment.author_email }}">
        </div>
